...
def extract_features(model, data_loader, print_freq=1, metric=None):
    ...
    print("Begin to extract train features...")
...
class Evaluator(object):
    ...
    def evaluate(self, data_loader, load_path, query, gallery, metric=None):
        if osp.exists(load_path):
            print("load features:{}".format(load_path))
